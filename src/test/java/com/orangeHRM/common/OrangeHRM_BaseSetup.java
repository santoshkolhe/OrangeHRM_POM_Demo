...
public class OrangeHRM_BaseSetup {
	...
	public void SetUp(){
		...
		htmlReporter.config().setDocumentTitle("Extend Report For OrangeHRM Tests");
		htmlReporter.config().setReportName("Extend Report For OrangeHRM Tests");
